...
<header class="NavigationMenu">
  ...
  <!--     <input type='button' value='イメージ表示' onclick="SelectPage(1);">
    ...
    <table style="clear: both;margin:auto;font-size:14px; font-weight: bold; ">
      <tr>
        <TD>　都道府県 <select name="selPref" id="selPref" ></select></TD>
 ...
 <body class="body" onload="dataInitialize()">
  <div id='page1' class='wrapper'>
        <div class="box1" style="margin:0 auto; text-align: right">
          <div id ="allpop" style="text-align:center; font-size:16px; font-weight: bold" >【市町村グラフ】</div>
          <!--<div style="display:block ;clear: both;">-->
          <div style="display:block ; clear:both">
            <canvas class="bcanvas" id="myCanvas"  width="380" height="400"></canvas>
            <canvas class="bcanvas" id="subCanvas" width="380" height="400" ></canvas>
          </div>
          <div style="display:block ;clear: both;">
            <canvas class="bcanvas"  id="areaCanvas" width="320" height="320" ></canvas>
            <div id="page2table" style="width:450px;float: left;" ></div> 
          </div>
          <div style="display:block ;clear: both;">
          <table class="table1" border="1" width="450" style="margin:auto;text-align:center;" id="table01">
            <thead style="text-align:center; background-color:#78fdf7">
            <tr>
            <Th id="dataName01"></Th>
            <Th >男性(人数）</Th>
            <Th >男性（比率）</Th>
        ...
        <tbody style="text-align:center" id="tbody01">  
        </tbody>
        </table>
        </div>
      </div>
      <div class="box2" style="margin:auto;text-align: left">
        <div id ="zenkoku" style="margin-top: 10px;text-align:center; font-size:16px; font-weight: bold" >【都道府県グラフ】</div>
        <div style="display:block ;clear: both;">
          <canvas class="bcanvas" id="prefCanvas" width="380" height="400" ></canvas>
          <!--<table border="2" style="text-align:right; grid-area: 2 / 1;" >-->
   
          <table class="table2" border="1"  width="500" style="margin:0 auto;text-align:right" id="table02" >
            <thead style="text-align:center;background-color:#78fdf7">
            <tr>
            <Th id="dataName02"></Th>
            <Th >男性(人数）</Th>
            ...
            <tbody style="text-align:center" id="tbody02">
            </tbody>
          </table>
        </div>
...
<!--  <div>
    <ul>
      <li>
        <div id="cityTD">ランキング選択 <select name="selRank" id="selRank" onchange="selectRank()"></select>
      </li>
      <li>
        <label><input type="radio" name="rankArea" value=1 checked>全国</label><BR>
        <label><input type="radio" name="rankArea" value=2 >県内</label>
      </li>

    </ul>
  </div>
-->
  <div id="page3table"></div>  
